...
public class DateChooser extends JPanel{
    ...
    private JButton showDate;//,toSelect;
    ...
    private void initLabel(){
        ...
        showDate.setIcon(new ImageIcon(getClass().getResource("images/day.png")));
        showDate.setToolTipText("选择日期");
        showDate.setBounds(900, 380, 380, 270);  
        showDate.setOpaque(false);  
        showDate.setContentAreaFilled(false);  
        showDate.setMargin(new Insets(0, 0, 0, 0));  
        showDate.setFocusPainted(false);  
        showDate.setBorderPainted(false);  
